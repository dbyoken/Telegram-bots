...
from click_pay import verify_click_signature

# Bu yerga o'z bot(lar)ingizning "buyurtma tasdiqlandi" funksiyasini ulang.
# Masalan, course_bot uchun: to'lov tasdiqlansa, mijozga kurs havolasini yuborish.
